...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_EVENTMESSAGE']._serialized_end=579
  _globals['_CYBEREVENTS']._serialized_start=582
  _globals['_CYBEREVENTS']._serialized_end=877
